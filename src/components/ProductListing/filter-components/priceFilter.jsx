...
const PriceFilter = () => {
    ...
    const minPriceHandler = (e) => productsDispatch({
        filterType: "MIN_PRICE",
        minPrice: e.target.value,
        progressStatusMinPrice: e.target.value*100 / filtersData.priceFilter.maxPrice + "%"
    })
    
    const maxPriceHandler = (e) => productsDispatch({
        filterType: "MAX_PRICE",
        maxPrice: e.target.value,
        progressStatusMaxPrice: (100 - e.target.value*100 / filtersData.priceFilter.maxPrice) + "%"
    })
        ...
        <ul className="outline-container price-slider p-5 my-5 b-radius-2 flex-column flex-gap-1 flex-wrap w-100  my-5">
          ...
          <article className="range-slider-container b-radius-1">
            <article className="range-slider-progress b-radius-1"
                style={{left: productsState.progressStatusMinPrice, right: productsState.progressStatusMaxPrice}} 
            ></article>
          </article>
